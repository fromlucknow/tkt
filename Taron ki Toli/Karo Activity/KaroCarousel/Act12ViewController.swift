...
class Act12ViewController: UIViewController {
    ...
    @IBAction func next(_ sender: Any) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "Act13ViewController") as! Act13ViewController
